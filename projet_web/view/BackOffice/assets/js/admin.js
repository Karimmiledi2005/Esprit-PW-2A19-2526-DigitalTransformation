...
function saveUserAdd() {
    ...
    fetch('../../controller/admin_add_user.php', { method: 'POST', body: data })
        .then(res => res.json())
        .then(res => {
            if (res.success) {
...
function saveUser() {
    ...
    if (editingId) {
        ...
        fetch('../../controller/admin_update_user.php', { method: 'POST', body: data })
            .then(res => res.json())
            .then(res => {
...
function toggleStatut(id) {
    ...
    fetch('../../controller/admin_toggle_statut.php', { method: 'POST', body: data })
        .then(res => res.json())
        .then(res => {
            if (res.success) {
...
function confirmDelete() {
    ...
    fetch('../../controller/admin_delete_user.php', { method: 'POST', body: data })
        .then(res => res.json())
        .then(res => {
            btn.innerHTML = orig; btn.disabled = false;
            if (res.success) {
