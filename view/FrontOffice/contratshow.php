...
$id = (int)($_GET['id'] ?? 0); //Elle récupère l’identifiant du contrat 
...
$qrCodeUrl = 'qrcode_contrat.php?id=' . urlencode((string)$id); //tu prépares un lien vers le fichier qui génère le QR Code :
$scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
$baseUrl = $scheme . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost') . rtrim(dirname($_SERVER['SCRIPT_NAME'] ?? ''), '/\\');
$qrTargetUrl = $baseUrl . '/contratshow.php?id=' . urlencode((string)$id);
...
// on l'affiche quand même pour ne pas perdre le choix du client.
...
<nav class="navbar">
    ...
    <div class="navbar-nav">
        ...
        <a class="nav-link active" href="contrat.php"><i class="bi bi-file-earmark-text"></i><span class="nav-label">Contrats</span></a>
    ...
    <div class="navbar-right">
        ...
        <div class="avatar-wrap">
            ...
            <div class="avatar-dropdown" id="avatarDropdown">
                ...
                <a class="dropdown-item" href="monprofile.html"><i class="bi bi-person"></i> Mon profil</a>
...
function exportContratPDF() {
    ...
    const garantiesChoisiesRows = pdfGarantiesChoisies.length
        ...
        `).join('')
        : `<tr><td colspan="3" class="muted">Aucune garantie associée à cette formule.</td></tr>`;
