...
<section class="auto-types-section">
    ...
    <div class="auto-types-grid">
        ...
        <!-- Basique -->
        <div class="auto-type-card" onclick="selectProtectionType('Individuelle')">
        ...
        <!-- Recommandé -->
        <div class="auto-type-card featured" onclick="selectProtectionType('Familiale')">
        ...
        <!-- Premium -->
        <div class="auto-type-card premium" onclick="selectProtectionType('Premium')">
