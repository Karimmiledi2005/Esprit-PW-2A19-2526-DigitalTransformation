        ...
        <div class="navbar-right">
            ...
            <div class="avatar-wrap">
                <div class="ptx-avatar-3d" id="avatarBtn" title="Mon compte">
                    ...
                    <div class="ptx-avatar-inner" id="avatarInitials">..</div>
                </div>
                <div class="avatar-dropdown" id="avatarDropdown">
                    <div class="dropdown-header">
                        <div class="dropdown-avatar" id="dropdownAvatar">..</div>
                        <div class="dropdown-info">
                            <div class="dropdown-name" id="dropdownName">Chargement...</div>
                            <div class="dropdown-email" id="dropdownEmail">...</div>
                            <span class="dropdown-role" id="dropdownRole">Client</span>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <div class="stats-grid">
                <div class="stat-card blue">
                    ...
                    <div class="stat-trend trend-up"><i class="bi bi-arrow-up"></i> Tous valides</div>
                </div>
                <div class="stat-card gold" style="cursor:pointer;" onclick="openSinistresPanel(event)" title="Voir mes sinistres">
                    ...
                    <div class="stat-label">Sinistre en cours</div>
                    <div class="stat-trend trend-warn"><i class="bi bi-clock"></i> En traitement</div>
                </div>
                <div class="stat-card green">
                    <div class="stat-icon"><i class="bi bi-credit-card"></i></div>
                    <div class="stat-value">847 <span>TND</span></div>
                    <div class="stat-label">Primes payées</div>
                    <div class="stat-trend trend-up"><i class="bi bi-arrow-up"></i> Cette année</div>
                </div>
                <div class="stat-card red">
                    <div class="stat-icon"><i class="bi bi-exclamation-triangle"></i></div>
                    <div class="stat-value">1</div>
                    <div class="stat-label">Réclamation ouverte</div>
                    <div class="stat-trend trend-down"><i class="bi bi-clock"></i> Réponse en attente</div>
                </div>
            </div>
            ...
            <div class="section-header">
                <div>
                    ...
                    <div class="section-sub">3 contrats actifs</div>
                </div>
                <a href="mes-contrats.html" class="btn btn-outline btn-sm">
                    <i class="bi bi-arrow-right"></i> Voir tout
                </a>
            </div>

            <div class="grid-3" style="margin-bottom: 28px;">
                <div class="contrat-card sante">
                    <div class="contrat-type">
                        <div class="contrat-icon"><i class="bi bi-heart-pulse"></i></div>
                        <div>
                            <div class="contrat-name">Santé Premium</div>
                            <div class="contrat-ref">REF-2024-001</div>
                        </div>
                    </div>
                    <div class="contrat-info">
                        <div class="info-item">
                            <label>Prime</label>
                            <span>120 TND/mois</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="contrat-actions">
                        <a href="#" class="btn btn-outline btn-sm"><i class="bi bi-eye"></i> Détails</a>
                        <a href="#" class="btn btn-outline btn-sm"><i class="bi bi-download"></i> PDF</a>
                    </div>
                </div>

                <div class="contrat-card auto">
                    <div class="contrat-type">
                        <div class="contrat-icon"><i class="bi bi-car-front"></i></div>
                        <div>
                            <div class="contrat-name">Auto Tous Risques</div>
                            <div class="contrat-ref">REF-2024-002</div>
                        </div>
                    </div>
                    <div class="contrat-info">
                        <div class="info-item">
                            <label>Prime</label>
                            <span>85 TND/mois</span>
                        </div>
                        <div class="info-item">
                            <label>Échéance</label>
                ...
                <div class="contrat-card maison">
                    <div class="contrat-type">
                        <div class="contrat-icon"><i class="bi bi-house-heart"></i></div>
                        <div>
                            <div class="contrat-name">Habitation</div>
                            <div class="contrat-ref">REF-2024-003</div>
                        </div>
                    </div>
                    <div class="contrat-info">
                        <div class="info-item">
                            <label>Prime</label>
                            <span>45 TND/mois</span>
                        </div>
                        <div class="info-item">
                            <label>Échéance</label>
                            <span>01 Mar 2027</span>
                        </div>
                    </div>
                    <div class="contrat-actions">
                        <a href="#" class="btn btn-outline btn-sm"><i class="bi bi-eye"></i> Détails</a>
            ...
            <div class="grid-2">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Sinistre en cours</div>
                        <a href="mes-sinistres.html" class="btn btn-outline btn-sm">Voir tout</a>
                    </div>
                    <div class="card-body">
                        <div class="sinistre-box">
                            <div class="sinistre-header">
                                <div class="sinistre-title">Accident auto — Tunis</div>
                                <span class="badge badge-warning">En traitement</span>
                            </div>
                            <div class="sinistre-meta">Déclaré le 2 Avril 2026 · REF-SIN-2026-001</div>
                            <div class="timeline">
                                <div class="timeline-item">
                                    <div class="timeline-dot green"></div>
                                    <div class="timeline-content">
                                        <div class="timeline-title">Déclaration reçue</div>
                                        <div class="timeline-date">2 Avril 2026</div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    <div class="timeline-dot blue"></div>
                                    <div class="timeline-content">
                                        <div class="timeline-title">Expertise planifiée</div>
                                        <div class="timeline-date">5 Avril 2026</div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    <div class="timeline-dot gold"></div>
                                    <div class="timeline-content">
                                        <div class="timeline-title">Rapport en cours</div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="paiements.html" class="btn btn-outline btn-sm">Voir tout</a>
                    </div>
                    <div class="card-body">
                        <div class="payment-item">
                            <div class="payment-left">
                                <div class="payment-icon"><i class="bi bi-heart-pulse"></i></div>
                                <div>
                                    <div class="payment-name">Santé Premium</div>
                                    <div class="payment-date">1 Avril 2026</div>
                                </div>
                            </div>
                            <div class="payment-right">
                                <div class="payment-amount">120 TND</div>
                                <span class="badge badge-success" style="font-size:10px">Payé</span>
                            </div>
                        </div>
                        <div class="payment-item">
                            <div class="payment-left">
                                <div class="payment-icon"><i class="bi bi-car-front"></i></div>
                                <div>
                                    <div class="payment-name">Auto Tous Risques</div>
                                    <div class="payment-date">1 Avril 2026</div>
                                </div>
                            </div>
                            <div class="payment-right">
                                <div class="payment-amount">85 TND</div>
                                <span class="badge badge-success" style="font-size:10px">Payé</span>
                            </div>
                        </div>
                        <div class="payment-item">
                            <div class="payment-left">
                                <div class="payment-icon gold"><i class="bi bi-house-heart"></i></div>
                                <div>
                                    <div class="payment-name">Habitation</div>
                                    <div class="payment-date">1 Mai 2026</div>
                                </div>
                            </div>
                            <div class="payment-right">
                                <div class="payment-amount">45 TND</div>
                                <span class="badge badge-warning" style="font-size:10px">À venir</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- AGENCES LOCATOR -->
            <div id="agences-locator" class="section-header" style="margin-top: 40px;">
                <div>
                    <div class="section-title">Nos Agences</div>
                    <div class="section-sub">Trouvez l'agence Protex la plus proche de chez vous</div>
                </div>
            </div>

            <div class="card" style="padding: 0; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.03);">
                <div style="display: flex; height: 500px; flex-wrap: wrap;">
                    <div style="flex: 1; min-width: 300px; border-right: 1px solid rgba(255,255,255,0.1); display: flex; flex-direction: column;">
                        <div style="padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.1);">
                            <div style="position: relative;">
                                <i class="bi bi-search" style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: rgba(255,255,255,0.4);"></i>
                                <input type="text" id="ptx-map-search" placeholder="Rechercher une agence..." 
                                       style="width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; padding: 10px 10px 10px 38px; color: #fff; outline: none; font-family: inherit;">
                            </div>
                        </div>
                        <div id="ptx-agency-list" style="flex: 1; overflow-y: auto; padding: 15px;">
                            <!-- Injected by JS -->
                        </div>
                    </div>
                    <div id="ptx-map" style="flex: 2; min-width: 400px; min-height: 350px;"></div>
                </div>
            </div>
...
<script>
    ...
    // ═══════════════════════════════════════════
    let spSinistres = [
        { id:1, contrat:'#1023', type:'Accident auto', description:'Accident sur autoroute A1, choc arrière.', date:'2026-04-05', statut:'en_attente', montant:null, photo:'user/img/sample.jpg', commentaires:[], traitements:[{ num:'T1', decision:'Documents reçus, en cours de vérification', date:'02/04/2026', montant:null }] },
        { id:2, contrat:'#998',  type:'Dégât des eaux', description:'Inondation cuisine suite rupture canalisation.', date:'2026-04-01', statut:'rembourse', montant:300, photo:'user/img/sample.jpg', commentaires:[{ texte:'Merci pour le traitement rapide !', date:'05/04/2026' }], traitements:[{ num:'T1', decision:'Documents reçus', date:'02/04/2026', montant:null },{ num:'T2', decision:'Sinistre validé après vérification', date:'05/04/2026', montant:300 }] }
    ];
    ...
    async function spOpenDeclareModal() {
        ...
        try {
            ...
            if (json.success && json.data) {
                ...
                selC.innerHTML = '<option value="">— Sélectionnez un contrat —</option>';
                json.data.forEach(c => {
                    const opt = document.createElement('option');
    ...
    <script>
        ...
        document.getElementById('ptx-map-search').addEventListener('input', function(e) {
