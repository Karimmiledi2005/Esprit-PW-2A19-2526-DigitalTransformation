...
// — via GET  (lien <a href="updateReclamation.php?id=X">)
// — via POST sans action (ancien formulaire avec <form>)
...
if (isset($_POST['action']) && $_POST['action'] === 'update') {
    try {
        ...
        if (empty($errors)) {
            ...
            // Recharger les données pour ré-afficher le formulaire
            ...
            <form method="POST" onsubmit="return validateReclamationForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="fEmail" name="email"
                           placeholder="Ex : karim.miledi@email.com"
