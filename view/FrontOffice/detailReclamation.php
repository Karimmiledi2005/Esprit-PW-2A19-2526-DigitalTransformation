...
// Vérification session (supporte `user_id` ou `id_user` selon modules)
...
// Récupère la réclamation (dédiée) et fusionne la réponse si présente
...
<div class="layout">
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav">
            ...
            <a class="nav-link" href="contrat.php"> <i class="bi bi-file-earmark-text"></i> <span class="nav-label">Contrats</span> </a>
            ...
            <a class="nav-link" href="reseau.html"> <i class="bi bi-people"></i> <span class="nav-label">Réseau</span> </a>
            <div class="nav-separator"></div>
            <a class="nav-link active" href="reclamationList.php"> <i class="bi bi-chat-dots"></i> <span class="nav-label">Réclamations</span> </a>
        </div>

        <div class="navbar-right">
            <div class="avatar-wrap">
                <div class="avatar-btn"><?php echo strtoupper(substr($_SESSION['nom']??'U',0,1).substr($_SESSION['prenom']??'P',0,1)); ?></div>
            </div>
        </div>
    </nav>
    ...
    <main class="main">
        ...
        <div class="rec-card <?php echo $statut; ?>" style="padding:24px;">
            ...
            <div class="rec-body" style="margin-bottom:20px;">
                <div class="rec-meta-item"> <label>Type</label> <span><?php echo h($row['type'] ?? '—'); ?></span> </div>
                <div class="rec-meta-item"> <label>Priorité</label> <span><?php echo h($row['priorite'] ?? '—'); ?></span> </div>
