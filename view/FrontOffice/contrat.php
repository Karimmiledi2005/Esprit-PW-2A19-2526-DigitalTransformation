...
$idUser = (int) ($_SESSION['id_user'] ?? $_SESSION['user_id']);
$idClient = $idUser;
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav">
            ...
            <a class="nav-link active" href="contrat.php">
                ...
                <span class="nav-badge accent"><?= (int)$nbContratsClient ?></span>
            </a>
