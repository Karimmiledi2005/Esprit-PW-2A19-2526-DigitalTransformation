    ...
    function initNavbar() {
        ...
        if (avatarBtn && avatarDropdown) {
            avatarBtn.onclick = function(e) {
                e.stopPropagation();
                const isOpen = avatarDropdown.classList.contains('open') || avatarDropdown.classList.contains('show');
                
                // Toggle logic
                if (isOpen) {
                    avatarDropdown.classList.remove('open', 'active', 'show');
                } else {
                    avatarDropdown.classList.add('open', 'active', 'show');
                }
            };
