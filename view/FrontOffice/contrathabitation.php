...
<div class="page-header">
    <div>
        <div class="page-title-main">Contrats Habitation</div>
...
<section class="category-hero-overlay habitation-hero">
    <img src="assets/habitation-cover.jpg" alt="Assurance habitation" class="hero-bg-img">

    <div class="hero-overlay"></div>

    <div class="category-hero-content">
        <span class="category-kicker">Habitation</span>
        <h1>Protégez votre logement en toute sérénité.</h1>
        <p>
            Sécurisez votre maison ou votre appartement avec une couverture
            adaptée à vos besoins essentiels.
        </p>

        <div class="category-hero-actions">
            <a href="#" class="hero-btn primary" onclick="openModal()">Souscrire</a>
            <a href="#habitation-contracts" class="hero-btn secondary">Voir mes contrats</a>
        </div>
    </div>
</section>
<section class="auto-types-section">
    <div class="auto-types-header">
        <span class="section-kicker">Formules habitation</span>
        <h2>Choisissez votre formule habitation</h2>
        <p>
            Sélectionnez la formule adaptée à votre logement pour protéger
            votre maison ou votre appartement selon vos besoins.
        </p>
    </div>

    <div class="auto-types-grid">

        <div class="auto-type-card" onclick="selectHomeType('Habitation')">
            ...
            <h3>Essentielle</h3>
            <p>Une couverture de base pour protéger votre logement contre les risques principaux.</p>

            <ul class="auto-type-features">
                <li><i class="bi bi-check-circle-fill included"></i> Garantie Incendie</li>
                <li><i class="bi bi-check-circle-fill included"></i> Garantie Dégâts des eaux</li>

                <li><i class="bi bi-plus-circle option"></i> Garantie Bris de glace</li>

                <li><i class="bi bi-circle not-available"></i> Garantie Vol</li>
                <li><i class="bi bi-circle not-available"></i> Garantie Responsabilité civile habitation</li>
            </ul>

            <div class="auto-type-footer">
                <span class="auto-type-price">À partir de 320 DT</span>
                <button type="button" class="choose-type-btn">Choisir</button>
            </div>
        </div>

        <div class="auto-type-card featured" onclick="selectHomeType('Habitation')">
            ...
            <h3>Confort</h3>
            <p>Une formule équilibrée avec des garanties complémentaires pour mieux sécuriser votre logement.</p>
            ...
            <ul class="auto-type-features">
                ...
                <li><i class="bi bi-plus-circle option"></i> Garantie Bris de glace</li>
                <li><i class="bi bi-plus-circle option"></i> Garantie Responsabilité civile habitation</li>
            </ul>

            <div class="auto-type-footer">
                <span class="auto-type-price">À partir de 540 DT</span>
                <button type="button" class="choose-type-btn">Choisir</button>
            </div>
        </div>

        <div class="auto-type-card premium" onclick="selectHomeType('Habitation')">
            ...
            <h3>Premium</h3>
            <p>Une protection complète pour votre logement et vos biens avec une couverture renforcée.</p>
            ...
            <ul class="auto-type-features">
                ...
                <li><i class="bi bi-check-circle-fill included"></i> Garantie Responsabilité civile habitation</li>

                <li><i class="bi bi-plus-circle option"></i> Garantie Assistance habitation</li>
            </ul>

            <div class="auto-type-footer">
                <span class="auto-type-price">À partir de 760 DT</span>
                <button type="button" class="choose-type-btn">Choisir</button>
            </div>
        </div>
...
<section class="guarantees-details">
    ...
    <div class="guarantees-container">
        ...
        <h2 class="guarantees-section-title">Comprendre les garanties habitation</h2>

        <p class="guarantees-section-subtitle">
            Consultez les garanties essentielles et les garanties complémentaires
            pour mieux comprendre la protection de votre logement.
        </p>
        ...
        <div class="guarantees-wrapper">
            ...
            <div class="guarantees-panel">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        Couvre les dommages causés au logement et à son contenu en cas d’incendie.
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        Prend en charge les dommages liés aux fuites, infiltrations et débordements d’eau.
                    </div>
                </div>
            </div>
            ...
            <div class="guarantees-panel">
                ...
                <div class="accordion-item active">
                    ...
                    <div class="accordion-content">
                        Couvre la perte ou les dommages causés aux biens du logement en cas de vol ou tentative de vol.
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        Prend en charge la réparation ou le remplacement des vitres et surfaces vitrées endommagées.
                    </div>
                </div>

                <div class="accordion-item">
                    <div class="accordion-header">
                        <span>Responsabilité civile habitation</span>
                        <i class="bi bi-plus-lg"></i>
                    </div>
                    <div class="accordion-content">
                        Couvre les dommages causés à des tiers dans le cadre de la vie privée ou liés au logement assuré.
                    </div>
                </div>

                <div class="accordion-item">
                    <div class="accordion-header">
                        <span>Assistance habitation</span>
                        <i class="bi bi-plus-lg"></i>
                    </div>
                    <div class="accordion-content">
                        Offre une aide rapide en cas d’urgence liée au logement, comme un dépannage ou une mise en sécurité.
                    </div>
                </div>
            </div>
...
<section class="content contracts-page">
    ...
    <div>
        <h2>Contrats Habitation</h2>
        <p>Consultez et gérez vos contrats habitation.</p>
    </div>
...
<?php foreach ($list as $contrat) {
    if ($contrat['type_contrat'] === 'Habitation') {
?>

<div class="contract-banner">

    <div class="contract-banner-left">
        <div class="contract-icon home">
            <i class="bi bi-house-door-fill"></i>
        </div>
        <div>
            <h3>Contrat Habitation</h3>
