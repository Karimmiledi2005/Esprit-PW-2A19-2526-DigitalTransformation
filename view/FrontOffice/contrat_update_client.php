...
function renderDetailField(string $key, $value, bool $canEdit): string {
    ...
    $selectOptions = [
        ...
        'nationalite' => ['Tunisienne', 'Algérienne', 'Française', 'Marocaine', 'Libyenne', 'Autre'],
    ...
    if ($matchedOptions !== null) {
        ...
        $html .= '<option value="">— Veuillez choisir une option —</option>';
...
<nav class="navbar">
    <a href="client.php" class="navbar-brand">
        ...
        <div><div class="logo-text">Protex</div><div class="logo-sub">Assurance Digitale</div></div>
    </a>
    <div class="navbar-nav">
        <a class="nav-link" href="client.php"><i class="bi bi-grid-1x2"></i><span class="nav-label">Tableau de bord</span></a>
        <a class="nav-link active" href="contrat.php"><i class="bi bi-file-earmark-text"></i><span class="nav-label">Contrats</span><span class="nav-badge accent"><?= (int)$nbContratsClient ?></span></a>
        <a class="nav-link" href="mes-sinistres.html"><i class="bi bi-shield-exclamation"></i><span class="nav-label">Sinistres</span></a>
        <a class="nav-link" href="paiements.html"><i class="bi bi-credit-card"></i><span class="nav-label">Paiements</span></a>
        <a class="nav-link" href="reclamationList.php"><i class="bi bi-chat-dots"></i><span class="nav-label">Réclamations</span></a>
        <a class="nav-link" href="agences.html"><i class="bi bi-geo-alt"></i><span class="nav-label">Agences</span></a>
        <a class="nav-link" href="nos-offres.html"><i class="bi bi-stars"></i><span class="nav-label">Nos offres</span></a>
    </div>
    <div class="navbar-right">
        <a href="#" class="nav-btn" title="Notifications"><i class="bi bi-bell"></i></a>
            ...
            <div class="avatar-dropdown" id="avatarDropdown">
                <div class="dropdown-head">
                    ...
                    <div>
                        ...
                        <div class="dropdown-role" id="dropdownRole">Client Protex</div>
                    </div>
                </div>
                <div class="dropdown-menu-list"><a href="monprofile.html"><i class="bi bi-person-circle"></i>Mon profil</a><a href="change_password.html"><i class="bi bi-shield-lock"></i>Sécurité</a><a href="logout.php"><i class="bi bi-box-arrow-right"></i>Déconnexion</a></div>
            </div>
        </div>
    </div>
</nav>
...
<main class="update-wrap">
    <section class="update-card">
        ...
        <?php if (!$canEdit): ?>
            <div class="alert-update"><i class="bi bi-info-circle"></i> Ce contrat est déjà traité. La modification client est disponible seulement avant validation ou après refus.</div>
        <?php endif; ?>
