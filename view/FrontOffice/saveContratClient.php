...
/*
    ...
    Quand le vrai login sera intégré, remplace ce bloc par la vraie session utilisateur.
*/
...
$telephone = postValue($_POST, ['telephone', 'tel', 'phone', 'telephone_client', 'client_telephone']);
