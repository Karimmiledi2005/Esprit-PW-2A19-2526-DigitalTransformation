...
<section class="auto-types-section">
    ...
    <div class="auto-types-grid">
        <div class="auto-type-card recommended" onclick="selectHealthType('Sante')">
        ...
        <div class="auto-type-card featured" onclick="selectHealthType('Sante')">
        ...
        <div class="auto-type-card premium" onclick="selectHealthType('Sante')">
