    ...
    <main class="main">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <a href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=ajouter"
                            ...
                            <tr class="offre-row"
                                ...
                                <td style="padding:14px 18px;">
                                    <div class="action-group">
                                        <a href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=modifier&id=<?= (int)($o['id_offre']??0) ?>"
                                           class="action-icon edit" title="Modifier">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <?php if ($statut==='active'): ?>
                                        <a href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=statut&id=<?= (int)($o['id_offre']??0) ?>&statut=suspendue"
                                           class="action-icon pause" title="Suspendre"
                                           onclick="return confirm('Suspendre cette offre ?')">
                                            <i class="bi bi-pause-circle"></i>
                                        </a>
                                        <?php elseif ($statut==='suspendue'): ?>
                                        <a href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=statut&id=<?= (int)($o['id_offre']??0) ?>&statut=active"
                                        ...
                                        <a href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=supprimer&id=<?= (int)($o['id_offre']??0) ?>"
