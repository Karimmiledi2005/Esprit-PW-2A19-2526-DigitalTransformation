...
if (empty($offre)) {
    header('Location: ' . $BASE_URL . '/controller/BackOffice/OffreController.php?erreur=Offre introuvable');
    exit;
}
?>
<!DOCTYPE html>
            ...
            <div class="confirm-wrap">
                <div class="danger-card">
                    ...
                    <div class="danger-card-body">
                        ...
                        <form method="post"
                              action="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php?action=supprimer&id=<?= (int)($offre['id_offre']??0) ?>">
