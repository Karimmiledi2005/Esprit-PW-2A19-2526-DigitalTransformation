...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item" href="<?= $BASE_URL ?>/controller/BackOffice/OffreController.php">
                <i class="bi bi-tags"></i> Offres
            </a>
            <a class="nav-item active" href="<?= $BASE_URL ?>/controller/BackOffice/PaiementController.php">
                        ...
                        <tr class="pay-row"
                            ...
                            <td>
                                <div class="action-wrap">
                                    <!-- Détail -->
                                    <a href="<?= $BASE_URL ?>/controller/BackOffice/PaiementController.php?action=detail&id=<?= (int)($p['id_paiement']??0) ?>"
                                    ...
                                    <?php if ($statut === 'en_attente'): ?>
                                    <!-- Valider -->
                                    <a href="<?= $BASE_URL ?>/controller/BackOffice/PaiementController.php?action=valider&id=<?= (int)($p['id_paiement']??0) ?>"
                                       class="action-btn validate" title="Valider"
                                       onclick="return confirm('Valider ce paiement ?')">
                                        <i class="bi bi-check2"></i>
                                    </a>
                                    <!-- Refuser -->
                                    <a href="<?= $BASE_URL ?>/controller/BackOffice/PaiementController.php?action=refuser&id=<?= (int)($p['id_paiement']??0) ?>"
                                       class="action-btn refuse" title="Refuser">
                                        <i class="bi bi-x-lg"></i>
                                    </a>
                                    <?php elseif ($statut === 'valide'): ?>
                                    <!-- Rembourser -->
                                    <a href="<?= $BASE_URL ?>/controller/BackOffice/PaiementController.php?action=rembourser&id=<?= (int)($p['id_paiement']??0) ?>"
