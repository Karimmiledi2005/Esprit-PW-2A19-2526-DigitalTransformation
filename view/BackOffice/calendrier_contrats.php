...
<div class="layout">
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item active" href="calendrier_contrats.php"><i class="bi bi-calendar-event"></i> Calendrier contrats</a>
      ...
      <a class="nav-item" href="reponse.html"><i class="bi bi-chat-dots"></i> Réclamations</a>
