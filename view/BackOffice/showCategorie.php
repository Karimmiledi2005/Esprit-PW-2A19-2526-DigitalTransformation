                ...
                <div class="modal-body">
                    <div class="detail-grid">
                        ...
                        <div class="detail-field full">
                            ...
                            <div class="detail-field-value"><?= htmlspecialchars($categorie['description_categorie'] ?? '—') ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
function renderFormulesPagination(total, start, end, totalPages) {
    ...
    info.textContent = `Affichage ${shownStart}–${shownEnd} sur ${total} formule${total > 1 ? 's' : ''}`;
