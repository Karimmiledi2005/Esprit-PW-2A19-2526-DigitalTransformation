                                ...
                                <tr class="formule-row"
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <a class="btn-soft danger" href="deleteFormule.php?id=<?= $id ?>" onclick="return confirm('Supprimer cette formule ?');"><i class="bi bi-trash3"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
function exportPDF() {
    ...
    printWindow.document.write(`
        ...
        <body>
            <div class="header">
                <div class="brand">
                    ...
                    <div>
                        ...
                        <div class="subtitle">Protex Assurance — Back Office</div>
                    </div>
                </div>
                <div class="meta">
            ...
            <div class="footer">Ce document contient uniquement les formules visibles après recherche, filtre et tri.</div>
