...
<div class="show-page">
    ...
    <div class="show-modal" role="dialog" aria-modal="true" aria-labelledby="updateContratTitle">
        ...
        <form method="POST" novalidate onsubmit="return validateContratBO()">
            ...
            <input type="hidden" name="statut_contrat" value="<?= h($contratData['statut_contrat'] ?? 'en attente') ?>">
                ...
                <div class="show-section">
                    ...
                    <div class="show-grid">
                        ...
                        <div class="show-field">
                            ...
                            <div class="show-value"><span class="show-status <?= h($statusClass) ?>"><?= h($contratData['statut_contrat'] ?? '—') ?></span></div>
                        </div>
                        <div class="show-field">
