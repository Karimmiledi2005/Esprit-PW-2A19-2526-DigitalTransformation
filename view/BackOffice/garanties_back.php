...
function exportPDF() {
    ...
    if (visibleRows.length === 0) {
        alert('Aucune garantie à exporter.');
        return;
    }
                ...
                <div class="content">
                    <div class="doc-title">
                        <div>
                            ...
                            <div class="note">Garanties visibles après recherche, filtre catégorie et tri par plafond.</div>
                        </div>
                    </div>
...
document.getElementById('sortSelect').addEventListener('change', filterGaranties);
</script>
