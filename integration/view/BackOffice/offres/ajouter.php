...
| IMPORTANT
|--------------------------------------------------------------------------
| Remplace /integration par le vrai nom de ton dossier projet dans htdocs.
*/
$BASE_URL = BASE_URL;
?>
<!DOCTYPE html>
            ...
            <div class="page-shell">
                ...
                <div class="form-panel">
                    <div class="form-panel-head">
                        <div class="form-head-left">
                            ...
                            <div>
                                ...
                                <div class="form-panel-sub">Renseignez toutes les informations nécessaires</div>
                            </div>
                        </div>
                    ...
                    <div class="form-panel-body">
                        <form class="form-grid" method="post" action="<?= $BASE_URL ?>/controller/OffreController.php?action=ajouter" novalidate>
                    ...
                    <div class="side-block">
                        ...
                        <div class="tip-list">
                            <div class="tip-item">
                                ...
                                <span>Choisissez un nom simple, clair et facile à identifier.</span>
                            </div>
                            <div class="tip-item">
                                <i class="bi bi-check2-circle"></i>
                                <span>Le prix annuel doit normalement être inférieur à prix mensuel × 12.</span>
                            </div>
                            <div class="tip-item">
                                <i class="bi bi-check2-circle"></i>
                                <span>Décrivez précisément la couverture pour éviter toute ambiguïté.</span>
                            </div>
                        </div>
                    </div>
                </aside>
