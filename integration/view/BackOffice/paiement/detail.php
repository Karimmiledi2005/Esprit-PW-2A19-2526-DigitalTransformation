...
<div class="layout">
    <aside class="sidebar">
        <div class="sidebar-logo">
            <img src="<?= e($BASE_URL) ?>/view/FrontOffice/logo.png" alt="logo" width="38" height="38" style="border-radius:9px;flex-shrink:0;">
            <div>
    ...
    <main class="main">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <a href="<?= e($BASE_URL) ?>/controller/PaiementController.php?action=index" class="topbar-btn" title="Retour à la liste">
        ...
        <div class="content">
            <div class="page-breadcrumb" style="margin-bottom:24px;">
                ...
                <a href="<?= e($BASE_URL) ?>/controller/PaiementController.php?action=index" style="color:inherit;text-decoration:none;">Paiements</a>
                <i class="bi bi-chevron-right" style="font-size:10px"></i>
                <span>Détail</span>
            </div>
                ...
                <div class="detail-card">
                    <div class="empty-box">
                        ...
                        <div class="action-bar" style="justify-content:center;margin-top:16px;">
                            <a href="<?= e($BASE_URL) ?>/controller/PaiementController.php?action=index" class="btnx">
                    ...
                    <div class="page-hero-head">
                        <div>
                            ...
                            <p class="page-hero-sub">
                                ...
                                offre souscrite, méthode de paiement, statut, échéance et données financières.
                            </p>
                        </div>
                        ...
                        <div class="payment-main">
                            <div class="payment-banner">
                                ...
                                <div>
                                    ...
                                    <div class="ref-badge">
                                        ...
                                        <?= e($paiement['reference_paiement'] ?? $paiement['reference'] ?? '—') ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="fields-grid">
                                ...
                                <div class="field-box full">
                                    ...
                                    <div class="field-value"><?= e($paiement['description'] ?? $paiement['motif'] ?? 'Aucune information supplémentaire.') ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="side-panel">
                            <div class="side-stack">
                                <div class="mini-info">
                                    ...
                                    <div class="mini-info-value"><?= e($paiement['reference_paiement'] ?? $paiement['reference'] ?? '—') ?></div>
                                ...
                                <div class="mini-info">
                                    ...
                                    <div class="mini-info-sub">État métier actuel de la transaction</div>
                                </div>
