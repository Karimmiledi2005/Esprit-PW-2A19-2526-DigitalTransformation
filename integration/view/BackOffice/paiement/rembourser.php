...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item" href="<?= e($BASE_URL) ?>/view/BackOffice/offres.html">
                <i class="bi bi-tags"></i> Offres
            </a>
            <a class="nav-item active" href="<?= e($BASE_URL) ?>/view/BackOffice/paiements.html">
        ...
        <div class="sidebar-footer">
            <a href="<?= e($BASE_URL) ?>/view/FrontOffice/login.html" class="logout-btn">
                        ...
                        <div class="side-panel">
                            <div class="side-stack">
                                ...
                                <div class="mini-info">
                                    ...
                                    <?php else: ?>
                                        <form method="post" action="<?= e($BASE_URL) ?>/controller/PaiementController.php?action=confirmer_remboursement" style="margin:0;" onsubmit="return verifierMotifRemboursement();">
                                            <input type="hidden" name="id" value="<?= (int)($paiement['id_paiement'] ?? 0) ?>">

                                            <div class="form-group">
                                                <label for="motif_remboursement" class="form-label">Motif du remboursement *</label>
                                                <textarea
                                                    id="motif_remboursement"
                                                    name="motif_remboursement"
                                                    class="form-textarea"
                                                    placeholder="Exemple : erreur de facturation, demande client validée, transaction annulée..."
                                                    required
                                                ><?= e($_POST['motif_remboursement'] ?? '') ?></textarea>
                                                <div class="form-help">
...
function verifierMotifRemboursement() {
    const textarea = document.getElementById('motif_remboursement');
