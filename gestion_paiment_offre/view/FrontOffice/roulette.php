...
<div class="modal-overlay" id="modalWin">
    <div class="modal-card" id="modalCard">
        ...
        <div class="modal-actions">
            <a href="/projet_web1/gestion_paiment_offre/controller/RouletteController.php?email=<?= urlencode($email) ?>" class="btn-primary">
...
async function spinWheel() {
    ...
    try {
        ...
        const response = await fetch('/projet_web1/gestion_paiment_offre/controller/RouletteController.php?action=tourner', {
