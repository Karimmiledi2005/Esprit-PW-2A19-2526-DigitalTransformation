...
<nav class="navbar">
    ...
    <div class="navbar-nav">
        ...
        <a class="nav-link <?= frontActive('roulette') ?>"
           href="/projet_web1/gestion_paiment_offre/controller/RouletteController.php">
            <i class="bi bi-dice-5"></i>
            <span class="nav-label">Roulette 🎰</span>
        </a>

        <a class="nav-link <?= frontActive('jeux', 'snake', 'memory') ?>"
           href="<?= $frontBase ?>/jeux.php">
    ...
    <div class="navbar-right">
        <a href="<?= $frontBase ?>/jeux.php" class="nav-btn nav-arrow-left-btn" title="Jeux">
            <i class="bi bi-controller"></i>
        </a>
        <a href="<?= $frontBase ?>/offres.php" class="nav-btn nav-arrow-right-btn" title="Suivant">
