<?php
$BASE_URL = '/projet_web1/gestion_paiment_offre';
$FRONT_URL = $BASE_URL . '/view/FrontOffice';
...
<link rel="stylesheet" href="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/css/variables.css">
<link rel="stylesheet" href="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/css/base.css">
<link rel="stylesheet" href="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/css/layout.css">
<link rel="stylesheet" href="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/css/client.css">
<link rel="stylesheet" href="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/css/light-theme.css">
    <style>
        :root {
                        ...
                        <form id="devisForm" action="<?= BASE_URL ?>/controller/DevisController.php?action=ajouter" method="POST" novalidate>
                            ...
                            <div class="devis-grid-2">
                                <div class="field">
                                    ...
                                    <input type="text" id="nom" name="nom" placeholder="Ben Salah" value="<?= htmlspecialchars($old['nom'] ?? '') ?>">
                                    <div class="field-error" id="err-nom"></div>
                                </div>
                                <div class="field">
                                    <label for="prenom"><i class="bi bi-person"></i> Prénom *</label>
                                    <input type="text" id="prenom" name="prenom" placeholder="Ali" value="<?= htmlspecialchars($old['prenom'] ?? '') ?>">
                            ...
                            <div class="devis-grid-2">
                                <div class="field">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="ali@gmail.com" value="<?= htmlspecialchars($old['email'] ?? '') ?>">
                                    <div class="field-error" id="err-email"></div>
                                </div>
                                <div class="field">
                                    <label for="telephone"><i class="bi bi-telephone"></i> Téléphone *</label>
                                    <input type="tel" id="telephone" name="telephone" placeholder="20123456" maxlength="8" value="<?= htmlspecialchars($old['telephone'] ?? '') ?>">
