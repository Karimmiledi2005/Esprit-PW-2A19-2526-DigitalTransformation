...
<body>
    <div class="payment-container">
        ...
        <div class="payment-card" id="payment-result" style="display:none;">
            ...
            <a href="/projet_web1/gestion_paiment_offre/view/FrontOffice/paiement.php?id_offre=<?= $offreId ?>&success=1&reference=<?= isset($reference) ? $reference : '' ?>" class="btn-back">
    ...
    <script>
        ...
        const BASE = '/projet_web1/gestion_paiment_offre';
        ...
        function showSuccess(ref, montant, offreId) {
            setTimeout(() => {
                window.location.href = '/projet_web1/gestion_paiment_offre/view/FrontOffice/paiement.php?id_offre=' + offreId + '&success=1&reference=' + ref;
            }, 1500);
