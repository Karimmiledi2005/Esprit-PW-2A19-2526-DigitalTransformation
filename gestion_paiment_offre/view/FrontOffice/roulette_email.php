        ...
        <div class="email-page-content">
            <div class="email-card">
                ...
                <div class="email-card-body">
                    <form class="email-form" method="get" action="/projet_web1/gestion_paiment_offre/controller/RouletteController.php">
                    ...
                    <a href="/projet_web1/gestion_paiment_offre/view/FrontOffice/client.html" class="email-back">
...
<script src="/projet_web1/gestion_paiment_offre/view/FrontOffice/assets/js/main.js"></script>
<script>
