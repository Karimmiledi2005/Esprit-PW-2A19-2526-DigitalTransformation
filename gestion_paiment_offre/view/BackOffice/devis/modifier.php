    ...
    <div class="content">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;margin-bottom:22px;">
            <div>
                ...
                <div class="page-breadcrumb">
                    ...
                    <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=index">Devis</a>
                    <i class="bi bi-chevron-right" style="font-size:10px"></i>
                    <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=details&id=<?= mE($devis['id_devis'] ?? '') ?>"><?= mE(mRef($devis['id_devis'] ?? 0)) ?></a>
                    <i class="bi bi-chevron-right" style="font-size:10px"></i>
                    <span>Modifier</span>
                </div>
            </div>
        ...
        <div class="action-bar">
            <div class="action-bar-left">
                <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=index" class="btn btn-outline">
                    <i class="bi bi-arrow-left"></i> Retour à la liste
                </a>
                <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=details&id=<?= mE($devis['id_devis'] ?? '') ?>" class="btn btn-outline">
                    <i class="bi bi-eye"></i> Voir les détails
                </a>
            </div>
            <div class="action-bar-right">
                <form method="POST"
                      action="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=supprimer&id=<?= mE($devis['id_devis'] ?? '') ?>"
        ...
        <!-- Formulaire -->
        <form method="POST"
              action="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=modifier&id=<?= mE($devis['id_devis'] ?? '') ?>"
              id="modForm">
            ...
            <div class="mod-layout">
                ...
                <div class="mod-aside">
                    ...
                    <div class="mod-card">
                        ...
                        <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=details&id=<?= mE($devis['id_devis'] ?? '') ?>"
