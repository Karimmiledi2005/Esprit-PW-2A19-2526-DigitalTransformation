                        ...
                        <?php else: ?>
                            <?php foreach ($devis as $d): ?>
                                ...
                                >
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=details&id=<?= urlencode((string)$d['id_devis']) ?>"
                                            ...
                                            <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=convertir&id=<?= urlencode((string)$d['id_devis']) ?>"
                                               class="btn btn-outline btn-sm"
