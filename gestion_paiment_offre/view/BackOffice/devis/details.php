...
if (!isset($devis)) {
    ...
    if ($id <= 0) {
        header('Location: /projet_web1/gestion_paiment_offre/controller/DevisController.php?action=index');
        exit;
    }
    ...
    if (!$devis) {
        header('Location: /projet_web1/gestion_paiment_offre/controller/DevisController.php?action=index&erreur=Devis+introuvable');
        exit;
    }
    ...
    <div class="content">
        ...
        <div class="action-bar">
            <div class="action-bar-left">
                ...
                <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=modifier&id=<?= $devis['id_devis'] ?>" class="btn btn-primary">
                    Modifier ce devis
                </a>
                <?php if ($statut === 'accepte'): ?>
                    <a href="/projet_web1/gestion_paiment_offre/controller/DevisController.php?action=convertir&id=<?= $devis['id_devis'] ?>" class="btn btn-success">
