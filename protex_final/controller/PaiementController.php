...
if (empty($_SESSION['user_id']) && empty($_SESSION['id_user'])) {
    ...
    header('Location: ' . $base . '/view/BackOffice/connexion.php'); exit;
}
...
class PaiementController
{
    ...
    {
        $root = defined('BASE_URL') ? BASE_URL : (defined('BASE_URL') ? BASE_URL : '/integration/protex_final');
            ...
            $mailer->envoyer(
                ...
                <div style='max-width:500px;margin:auto;background:#fff;border-radius:18px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08);'>
                    ...
                    <div style='padding:30px;'>
                        ...
                        <a href='" . (defined('BASE_URL') ? 'http://' . $_SERVER['HTTP_HOST'] . BASE_URL : 'http://localhost:8081/integration/protex_final') . "/controller/RouletteController.php?email=" . urlencode($email) . "'
