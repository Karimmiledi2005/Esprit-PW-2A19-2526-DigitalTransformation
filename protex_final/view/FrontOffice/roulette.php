...
$frontBase = (defined('BASE_URL') ? BASE_URL : '/integration/protex_final') . '/view/FrontOffice';
...
<script>
const BASE_URL_JS = <?= json_encode(defined('BASE_URL') ? BASE_URL : '/integration/protex_final') ?>;
