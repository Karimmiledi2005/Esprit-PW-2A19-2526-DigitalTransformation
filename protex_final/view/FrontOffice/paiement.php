...
<?php if ($showSuccess): ?>
            ...
            <section class="success-wrap">
                ...
                <div class="success-actions">
                    <a href="client.html" class="btn btn-success btn-lg"><i class="bi bi-grid-1x2"></i> Tableau de bord</a>
...
<script>
    const BASE = '<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>';
