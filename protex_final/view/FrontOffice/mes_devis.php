...
if (!defined('BASE_URL')) {
    define('BASE_URL', (defined('BASE_URL') ? BASE_URL : '/integration/protex_final'));
}
...
if ($email !== '') {
    try {
        ...
        if (empty($devis)) {
            $message = "Aucun devis trouvé avec cet email.";
        }
    } catch (Exception $e) {
...
<main class="devis-page">
    ...
    <section class="search-card">
        <form method="GET" class="search-form">
            ...
            <button type="submit" class="btn-protex">
    ...
    <?php if ($email === ''): ?>
        <section class="empty-state">
            ...
            <p>
                Utilisez le même email que celui saisi pendant la demande de devis.
            </p>
        </section>
    <?php elseif (!empty($devis)): ?>
    ...
    <?php else: ?>
        ...
        <section class="empty-state">
            ...
            <p>
                Vérifiez votre email ou créez une nouvelle demande de devis.
            </p>
