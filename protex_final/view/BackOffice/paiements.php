...
$__base = defined('BASE_URL') ? BASE_URL : '/integration/protex_final';
?>
...
<head>
    ...
    <title>Paiements — BackOffice Protex</title>
    ...
    <script>
        const TARGET_URL = "<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/PaiementController.php";

        function goToPaiements() {
            window.location.href = TARGET_URL;
        }

        // redirection auto
        window.onload = () => {
            setTimeout(goToPaiements, 1200);
        };
    </script>
</head>
<body>
...
<div class="card">
    ...
    <p>Chargement du module Paiements...</p>

    <div class="spinner"></div>

    <a class="btn" href="<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/PaiementController.php">
