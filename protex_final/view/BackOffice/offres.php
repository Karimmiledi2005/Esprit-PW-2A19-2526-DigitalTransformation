...
<head>
    ...
    <script>
        const TARGET_URL = "<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/OffreController.php";
    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="actions">
                ...
                <a class="btn btn-secondary" href="' + BASE_URL_PHP + '/view/BackOffice/admin-users.html">Retour au tableau de bord</a>
            </div>
