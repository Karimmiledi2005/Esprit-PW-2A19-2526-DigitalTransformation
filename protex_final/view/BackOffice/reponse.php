...
<head>
  ...
  <style>
    ...
    /* Largeurs colonnes tableau réclamations (Adaptatif selon rôle) */
...
<div class="modal-overlay" id="modalRepondre">
  <div class="modal">
    ...
    <div class="form-group">
      ...
      <!-- AI SUGGESTIONS -->
      <div id="suggestionsBox" style="margin-top:15px; display:none;">
...
.then(profileData => {
    ...
    if (roleEl && profileData.role) {
        ...
        if (profileData.nom_agence) roleTxt += ' (' + profileData.nom_agence + ')';
