            ...
            <div class="content">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card gold">
                        ...
                        <div class="stat-label">Nouveaux inscrits ce mois</div>
                        <div class="stat-trend up" id="newTrend"><i class="bi bi-arrow-up-right"></i> Ce mois</div>
                    </div>
                    <div class="stat-card green">
                        <i class="bi bi-person-check stat-bg-icon"></i>
                        <div class="stat-icon"><i class="bi bi-person-check"></i></div>
                        <div class="stat-value" id="kpiActifs">—</div>
                        <div class="stat-label">Comptes actifs</div>
                    </div>
                    <div class="stat-card purple">
                        <i class="bi bi-person-slash stat-bg-icon"></i>
            ...
            .then(data => {
                ...
                document.querySelectorAll('.user-avatar').forEach(el => {
                    if (avatarPath) {
                        ...
                        if (!el.querySelector('img')) el.textContent = initiales;
                    }
                });
                ...
                if (roleEl && data.role) {
                    let roleTxt = data.role.charAt(0).toUpperCase() + data.role.slice(1);
                    if (data.nom_agence) {
            ...
            fetch('get_sos_admin.php')
                ...
                .then(data => {
                    ...
                    if (data.alerts.length === 0) {
                        list.innerHTML = '<div style="text-align:center; padding:40px; color:rgba(255,255,255,0.2);">Aucune alerte récente</div>';
        ...
        function loadOnlineUsers() {
            fetch('get_stats.php')
                ...
                .then(data => {
                    ...
                    list.innerHTML = data.online_users.map(u => `
            <div style="display:flex; align-items:center; gap:10px; padding:10px 0; border-bottom:1px solid rgba(255,255,255,0.03);">
                <div style="position:relative;">
                    <img src="${u.avatar_url || '../FrontOffice/default.png'}" style="width:30px; height:30px; border-radius:50%; object-fit:cover;">
                    <div style="position:absolute; bottom:0; right:0; width:8px; height:8px; background:#2ed573; border:1.5px solid #0f172a; border-radius:50%;"></div>
                </div>
                <div style="flex:1;">
                    <div style="font-size:13px; color:#fff; font-weight:600;">${u.prenom} ${u.nom}</div>
                    <div style="font-size:10px; color:rgba(255,255,255,0.4);">${u.role.toUpperCase()}</div>
                </div>
                <div style="font-size:10px; color:rgba(255,255,255,0.3);">Actif</div>
            </div>
        `).join('');
                });
        }
