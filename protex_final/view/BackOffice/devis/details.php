...
if (!isset($devis)) {
    if (!defined('BASE_URL')) define('BASE_URL', (defined('BASE_URL') ? BASE_URL : '/integration/protex_final'));
    include_once __DIR__ . '/../../../config.php';

    $id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
    if ($id <= 0) {
        header('Location: ' . (defined('BASE_URL') ? BASE_URL : '/integration/protex_final') . '/controller/DevisController.php?action=index');
        exit;
    }
    ...
    if (!$devis) {
        header('Location: ' . (defined('BASE_URL') ? BASE_URL : '/integration/protex_final') . '/controller/DevisController.php?action=index&erreur=Devis+introuvable');
        exit;
    }
...
if (!defined('BASE_URL')) define('BASE_URL', (defined('BASE_URL') ? BASE_URL : '/integration/protex_final'));
$base = (defined('BASE_URL') ? BASE_URL : '/integration/protex_final');
    ...
    <div class="content">
        ...
        <div class="page-header-flex">
            <div>
                ...
                <div class="page-breadcrumb">
                    ...
                    <a href="<?= dE($base) ?>/view/BackOffice/admin.html">Accueil</a>
                    <i class="bi bi-chevron-right" style="font-size:10px"></i>
                    <a href="<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/DevisController.php?action=index">Devis</a>
                    <i class="bi bi-chevron-right" style="font-size:10px"></i>
        ...
        <div class="action-bar">
            <div class="action-bar-left">
                <a href="<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/DevisController.php?action=index" class="btn btn-outline">
                    <i class="bi bi-arrow-left"></i> Retour à la liste
                </a>
                <a href="<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/DevisController.php?action=modifier&id=<?= $devis['id_devis'] ?>" class="btn btn-primary">
                    Modifier ce devis
                </a>
                <?php if ($statut === 'accepte'): ?>
                    <a href="<?= defined('BASE_URL') ? BASE_URL : '/integration/protex_final' ?>/controller/DevisController.php?action=convertir&id=<?= $devis['id_devis'] ?>" class="btn btn-success">
